...
int main(int argc, char** argv)
{
	...
	int indice = 0;  
    int totalPessoas = 5;
    float percentFaixa1 = (static_cast<float>(faixa1) / totalPessoas) * 100;
    float percentFaixa4 = (static_cast<float>(faixa4) / totalPessoas) * 100;
	string precoa;
    bool found = false;
	while (op != 0)
	{
		...
		case 1:
			...
			gosta_atcout<<"\nCadastro de Produtos\n";letismo[indice] = (resposta[indice] == 'S');
        ...
        /* Listagem dos produtos com determinados preços */
		    case 5:
                ...
                for (int i = 0; i < indice; i++) 
				{
                 if (preco[i] == precoa) 
				 {
                  ...
                  if (!found) 
				  {
                    ...
                    break;
        /* Lista das últimas 10 vendas. Deve-se colocar o status "vendido" em "situação" na case 4 para funcionar. */
              case 6:
